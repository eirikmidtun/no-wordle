...
export default function Wordle() {
  ...
  const updateLetterStates = useCallback((cells: Cell[]) => {
  ...
  const submitGuess = useCallback(() => {
    ...
    if (!upperWords.includes(upperGuess)) {
      alert('Ordet finnes ikke i ordlisten!');
      return;
    }

    const evaluatedCells = evaluateGuess(currentGuess.toUpperCase(), targetWord);
    ...
    setCurrentGuess('');
  }, [currentGuess, targetWord, guesses, gameState, evaluateGuess, updateLetterStates]);
  ...
  // Render cell
  const renderCell = (cell: Cell | undefined, rowIndex: number, colIndex: number) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: isSpecial ? '0.875rem' : '1rem',
                      height: '2.5rem',
                      fontWeight: '600',
